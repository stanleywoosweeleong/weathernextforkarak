...
plantation locations around Karak, Pahang. Bilingual interface
...
|---|---|---|
| Borneo Spring | 婆罗青泉 | 3.492000, 102.024000 |
| Kg. Sungai Dua | 甘榜双溪都亚 | 3.45972, 102.00000 |
...
```
wnext-weathernextforkarak-202605260700
```
...
- **Storage namespace:** `weathernextforkarak__*` keys in `localStorage`,
